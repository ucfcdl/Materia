...
def translate_timestamps(apps, schema_editor):
    ...
    Asset.objects.bulk_update(
        all_assets, ["created_at_dt", "deleted_at_dt"], batch_size=BATCH_SIZE
    )
    ...
    AssetData.objects.bulk_update(
        all_asset_data, ["created_at_dt"], batch_size=BATCH_SIZE
    )
    ...
    DateRange.objects.bulk_update(
        all_date_ranges, ["start_at_dt", "end_at_dt"], batch_size=BATCH_SIZE
    )

    # Warning: takes a long time to run on large datasets
    ...
    for ids in chunk_ids(Log.objects.last().id, 10000):
    ...
    LogActivity.objects.bulk_update(
        all_log_activities, ["created_at_dt"], batch_size=BATCH_SIZE
    )

    # TODO: need to optimize LogPlay migration due to size
    ...
    LogPlay.objects.bulk_update(
        batch_logplays, ["created_at_dt"], batch_size=BATCH_SIZE
    )
    ...
    LogStorage.objects.bulk_update(
        all_log_storages, ["created_at_dt"], batch_size=BATCH_SIZE
    )
    ...
    Lti.objects.bulk_update(
        all_ltis, ["created_at_dt", "updated_at_dt"], batch_size=BATCH_SIZE
    )
    ...
    Notification.objects.bulk_update(
        all_notifications, ["created_at_dt", "updated_at_dt"], batch_size=BATCH_SIZE
    )
    ...
    PermObjectToUser.objects.bulk_update(
        all_potus, ["expires_at_dt"], batch_size=BATCH_SIZE
    )
    ...
    UserExtraAttempts.objects.bulk_update(
        all_ueas, ["created_at_dt"], batch_size=BATCH_SIZE
    )
    ...
    Question.objects.bulk_update(
        all_questions, ["created_at_dt"], batch_size=BATCH_SIZE
    )
    ...
    Widget.objects.bulk_update(all_widgets, ["created_at_dt"], batch_size=BATCH_SIZE)
    ...
    WidgetInstance.objects.bulk_update(
        all_wis, ["created_at_dt"], batch_size=BATCH_SIZE
    )
    ...
    WidgetQset.objects.bulk_update(all_wqets, ["created_at_dt"], batch_size=BATCH_SIZE)
...
def translate_datetimes(apps, schema_editor):
    ...
    Asset.objects.bulk_update(
        all_assets, ["created_at", "deleted_at"], batch_size=BATCH_SIZE
    )
    ...
    AssetData.objects.bulk_update(all_asset_data, ["created_at"], batch_size=BATCH_SIZE)
    ...
    DateRange.objects.bulk_update(
        all_date_ranges, ["start_at", "end_at"], batch_size=BATCH_SIZE
    )
    ...
    Log.objects.bulk_update(all_log_activities, ["created_at"], batch_size=BATCH_SIZE)
    ...
    LogActivity.objects.bulk_update(
        all_log_activities, ["created_at"], batch_size=BATCH_SIZE
    )
    ...
    LogPlay.objects.bulk_update(all_log_plays, ["created_at"], batch_size=BATCH_SIZE)
    ...
    LogStorage.objects.bulk_update(
        all_log_storages, ["created_at"], batch_size=BATCH_SIZE
    )
    ...
    Lti.objects.bulk_update(
        all_ltis, ["created_at", "updated_at"], batch_size=BATCH_SIZE
    )
    ...
    Notification.objects.bulk_update(
        all_notifications, ["created_at", "updated_at"], batch_size=BATCH_SIZE
    )
    ...
    PermObjectToUser.objects.bulk_update(
        all_potus, ["expires_at"], batch_size=BATCH_SIZE
    )
    ...
    UserExtraAttempts.objects.bulk_update(
        all_ueas, ["created_at"], batch_size=BATCH_SIZE
    )
    ...
    Question.objects.bulk_update(all_questions, ["created_at"], batch_size=BATCH_SIZE)
    ...
    Widget.objects.bulk_update(all_widgets, ["created_at"], batch_size=BATCH_SIZE)
    ...
    WidgetInstance.objects.bulk_update(all_wis, ["created_at"], batch_size=BATCH_SIZE)
    ...
    WidgetQset.objects.bulk_update(all_widgets, ["created_at"], batch_size=BATCH_SIZE)
