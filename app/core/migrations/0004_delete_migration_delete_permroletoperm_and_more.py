...
class Migration(migrations.Migration):
    ...
    def clean_data(apps, schema_editor):
        ...
        logger.info(
            f"deleting {invalid_widget_instance_rows.count()} invalid WidgetInstance rows without matching user_id User"
        )
        invalid_widget_instance_rows.delete()
        ...
        logger.info(
            f"deleting {invalid_widget_instance_rows.count()} invalid WidgetInstance rows without matching Widget"
        )
        invalid_widget_instance_rows.delete()
        ...
        logger.info(
            f"deleting {invalid_widget_qset_rows.count()} invalid WidgetQset rows without matching WidgetInstance"
        )
        invalid_widget_qset_rows.delete()
        ...
        logger.info(
            f"deleting {invalid_log_activity_rows.count()} LogActivity rows without matching User"
        )
        invalid_log_activity_rows.delete()

        # LogPlay -> WidgetInstance via inst_id
        invalid_log_play_rows = OldLogPlay.objects.exclude(inst_id__in=all_instance_ids)
        logger.info(
            f"deleting {invalid_log_play_rows.count()} LogPlay rows without matching WidgetInstance"
        )
        invalid_log_play_rows.delete()

        # LogPlay -> WidgetQset via qset_id
        invalid_log_play_rows = OldLogPlay.objects.exclude(qset_id__in=all_qset_ids)
        logger.info(
            f"deleting {invalid_log_play_rows.count()} LogPlay rows without matching WidgetQset"
        )
        invalid_log_play_rows.delete()
        ...
        logger.info(
            f"deleting {invalid_log_play_rows.count()} LogPlay rows without matching DateRange"
        )
        invalid_log_play_rows.delete()
        ...
        logger.info(
            f"deleting {invalid_log_play_rows.count()} LogPlay rows without matching User"
        )
        invalid_log_play_rows.delete()

        # all LogPlay rows should be valid by now
        ...
        logger.info(
            f"deleting {invalid_lti_rows.count()} Lti rows without matching WidgetInstance"
        )
        invalid_lti_rows.delete()
        ...
        logger.info(
            f"deleting {invalid_lti_rows.count()} Lti rows without matching User"
        )
        invalid_lti_rows.delete()
        ...
        logger.info(
            f"deleting {invalid_logstorage_rows.count()} LogStorage rows without matching WidgetInstance"
        )
        ...
        logger.info(
            f"deleting {invalid_logstorage_rows.count()} LogStorage rows without matching LogPlay"
        )
        invalid_logstorage_rows.delete()
        ...
        logger.info(
            f"deleting {invalid_logstorage_rows.count()} LogStorage rows without matching User"
        )
        invalid_logstorage_rows.delete()
        ...
        logger.info(
            f"deleting {invalid_permobjectotouser_rows.count()} PermObjectToUser rows without matching User"
        )
        invalid_permobjectotouser_rows.delete()
        ...
        logger.info(
            f"deleting {invalid_widgetmetadata_rows.count()} WidgetMetadata rows without matching Widget"
        )
