...
FONTS_DEFAULT = [
    ...
    FONTS_BASEURL + "css2?family=Lato:ital,wght@0,300;0,400;0,700;0,900;1,700&display=block"
]
...
CSS_GROUPS = {
    ...
    "catalog": [
        CSS_BASEURL + "catalog.css"
    ],
    "detail": [
        CSS_BASEURL + "detail.css"
    ],
    "player": [
        CSS_BASEURL + "player-page.css"
    ],
    "login": [
        CSS_BASEURL + "login.css"
    ],
    "profile": [
        CSS_BASEURL + "profile.css"
    ],
    "settings": [
